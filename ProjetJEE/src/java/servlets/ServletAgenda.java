        ...
        if (action != null) { 
            if (action.equals("connexion"))  {
                ...
                request.setAttribute("currentdate", dateF);
                    ...
                    String year2 = new SimpleDateFormat("yyyy").format(cal.getTime());
                    ...
                    String year3 = new SimpleDateFormat("yyyy").format(cal.getTime());
